...
impl GameApi2<BackendGameError> for BackendGameApi {
    async fn host_game(&mut self, p1_id: String) -> Result<String, BackendGameError> {
        ...
        match storage_result {
            ...
            Err(e) => Err(BackendGameError::Internal(Cause::Storage("Failed to list game as hosted.", Arc::new(e))))
        }
    }
